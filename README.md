...
📊 **발표자료 전체 보기 (온라인)**: https://claude.ai/code/artifact/00cd1f76-bef7-4527-9bda-116ad5f70d45
📋 **강의 준비 자료집 (온라인, 강사용)**: https://claude.ai/code/artifact/abd350bb-28f6-448a-b1f2-e2d65c31d0dd
🎬 **진행자용 운영 플레이북 (원문)**: [docs/facilitation-guide.md](docs/facilitation-guide.md) · 블록별 대본 [day1](docs/day1-facilitator.md)·[day2](docs/day2-facilitator.md)·[day3](docs/day3-facilitator.md)·[day4](docs/day4-facilitator.md)
...
커리큘럼 실습과 프로젝트 메뉴는 세일즈 조직에서 흔히 반복되는 수작업 예시 8개에서 나왔다 → [docs/plays-mapping.md](docs/plays-mapping.md)
...
├── slides/                  발표 슬라이드 (kickoff 14 · day1~3 각 3 · day4 6 · tips 8) + artifact-deck.html
│   └── (각 폴더 viewer.html을 로컬 서버로 열거나, 위 아티팩트 링크로 온라인 열람)
├── docs/
│   ├── facilitation-guide.md  진행자용 운영 플레이북 (2주 타임라인 · 세션 진행 · 과제 정합성)
│   ├── plays-mapping.md       세일즈 플레이 예시 8개 → 커리큘럼 매핑
│   ├── project-menu.md        2주차 프로젝트 메뉴
│   ├── fact-check-6.md        AI로 쓰레기 안 만들기 — 팩트체크 6단계 + 사고방식
│   └── improve-loop.md        의사결정 로그 루프 (Gong·Anthropic 방법론)
